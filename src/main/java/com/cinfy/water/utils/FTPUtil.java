...
public class FTPUtil {
	...
	static  int port = 21;
	static  String user = "uploader@digilibrary.cinfysystems.com";
	static  String pass = "Digital@2018";
	static String domainName="http://cinfysystems.com/";
	static String uploadDir="digilibrary/";
	
	
//	static  String server = "ftp.tourismjabalpur.org";
//	static  int port = 21;
//	static  String user = "upload@tourismjabalpur.org";
//	static  String pass = "World#2018";
//	static String domainName="https://tourismjabalpur.org/";
//	static String uploadDir="tourism_upload/";
	
//	static  String server = "ftp.praadiscg.com";
//	static  int port = 21;
//	static  String user = "tourism@praadiscg.com";
//	static  String pass = "India@123";
	...
	public static String uplo(MultipartFile file,String folder){
	  ...
	  //  return "http://www.praadiscg.com/tourism/"+storeLoc;
	    return domainName+uploadDir+storeLoc;
	}
	
	public static String uploadFileByte(String fileString , String name, String folder) {
        ...
        try {
            ...
            filePath=folder+"/"+System.currentTimeMillis()+"_"+"riview.jpg";

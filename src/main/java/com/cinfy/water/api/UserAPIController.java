...
import com.cinfy.water.api.service.LoginService;
...
//			
//			UserPayload register = mapper.readValue(mapper.writeValueAsString(request.getData()),
//					UserPayload.class);
//			
...
//			UserPayload resetPassword = mapper.readValue(mapper.writeValueAsString(request.getData()), UserPayload.class);
